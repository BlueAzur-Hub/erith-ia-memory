...
- [ERITH.IA — Mode Hors-Lore — Style Lock V1](public/erith_ia_mode_hors_lore_style_lock_v1.md) — mode Auto-Agent modulaire permettant de générer des univers originaux sans Neo Midgar ni Aerith-7, avec modules injectables comme Ghost in the Shell, Blade Runner, la Machine à Présages et l’Épée de Vérité.
---
