...
function applyBackground(){const current=backgrounds[bgIndex%backgrounds.length];document.getElementById("backgroundLayer").style.backgroundImage=`linear-gradient(90deg, rgba(0,0,0,.46), rgba(0,0,0,.12), rgba(0,0,0,.46)),linear-gradient(180deg, rgba(0,0,0,.08), rgba(0,0,0,.46)),url("${current}")`}
