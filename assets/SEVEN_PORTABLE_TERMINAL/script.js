...
const castleBackgrounds=[
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FLOATING_CITY_1920x1080.png", label:"Château · Floating City"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MINING_TOWN_SUNRISE_1920x1080.png", label:"Château · Mining Town Sunrise"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_APPROACH_1920x1080.png", label:"Château · Airship Approach"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_STORYBOOK_FLOATING_CITY_1920x1080.png", label:"Château · Storybook Floating City"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TOWN_STREET_FIGHT_1920x1080.png", label:"Château · Town Street Fight"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CARRIAGE_STREET_CHAOS_1920x1080.png", label:"Château · Carriage Street Chaos"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CLIFFSIDE_INDUSTRIAL_CITY_1920x1080.png", label:"Château · Cliffside Industrial City"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_STEAM_TRAIN_TRESTLE_CANYON_1920x1080.png", label:"Château · Steam Train Trestle Canyon"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MOUNTAIN_STONE_HOUSE_1920x1080.png", label:"Château · Mountain Stone House"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_UNDERGROUND_CRYSTAL_MINE_1920x1080.png", label:"Château · Underground Crystal Mine"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_ROBOT_RELIC_1920x1080.png", label:"Château · Ancient Robot Relic"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SKY_PIRATE_FAMILY_TABLE_1920x1080.png", label:"Château · Sky Pirate Family Table"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CHILDHOOD_MEMORY_HEARTH_1920x1080.png", label:"Château · Childhood Memory Hearth"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PROTECTIVE_PENDANT_AWAKENING_1920x1080.png", label:"Château · Protective Pendant Awakening"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_BURNING_FORTRESS_AIRSHIP_1920x1080.png", label:"Château · Burning Fortress Airship"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PRINCESS_AND_PIRATE_GRANDMOTHER_1920x1080.png", label:"Château · Princess And Pirate Grandmother"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GRANDPARENTS_PLAYING_CHESS_1920x1080.png", label:"Château · Grandparents Playing Chess"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_COMMAND_ROOM_1920x1080.png", label:"Château · Airship Command Room"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CASTLE_CLOSE_VIEW_1920x1080.png", label:"Château · Castle Close View"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SACRED_GARDENS_1920x1080.png", label:"Château · Sacred Gardens"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_SANCTUARY_GATE_1920x1080.png", label:"Château · Ancient Sanctuary Gate"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_FOREST_PATH_1920x1080.png", label:"Château · Ancient Forest Path"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_OVERGROWN_GREENHOUSE_DOME_1920x1080.png", label:"Château · Overgrown Greenhouse Dome"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TREE_CROWN_CASTLE_1920x1080.png", label:"Château · Tree Crown Castle"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MEMORIAL_STONE_PLAQUE_1920x1080.png", label:"Château · Memorial Stone Plaque"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GARDIAN_TREE_MEMORY_1920x1080.png", label:"Château · Gardian Tree Memory"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_DOCKING_SKY_RUINS_1920x1080.png", label:"Château · Airship Docking Sky Ruins"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TREASURE_MECHANICAL_RELICS_1920x1080.png", label:"Château · Treasure Mechanical Relics"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ROOTS_CRYSTAL_CORE_1920x1080.png", label:"Château · Roots Crystal Core"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_FIRE_BLAST_1920x1080.png", label:"Château · Airship Fire Blast"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_HEIR_WATCHING_AIRSHIP_1920x1080.png", label:"Château · Heir Watching Airship"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CRYSTAL_SELF_DESTRUCTION_SPELL_1920x1080.png", label:"Château · Crystal Self Destruction Spell"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CRUMBLING_ROOT_TOWER_1920x1080.png", label:"Château · Crumbling Root Tower"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FLOATING_ISLAND_ROOTS_OVERVIEW_1920x1080.png", label:"Château · Floating Island Roots Overview"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GLIDER_OVER_SACRED_GARDENS_1920x1080.png", label:"Château · Glider Over Sacred Gardens"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PIRATES_TREASURE_JOY_1920x1080.png", label:"Château · Pirates Treasure Joy"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SKY_PIRATES_ESCAPE_1920x1080.png", label:"Château · Sky Pirates Escape"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FINAL_ASCENSION_NIGHT_1920x1080.png", label:"Château · Final Ascension Night"},
  {file:"/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FINAL_RETURN_SUNSET_1920x1080.png", label:"Château · Final Return Sunset"}
];
...
const backgroundPositions={
  ...
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FLOATING_CITY_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MINING_TOWN_SUNRISE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_APPROACH_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_STORYBOOK_FLOATING_CITY_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TOWN_STREET_FIGHT_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CARRIAGE_STREET_CHAOS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CLIFFSIDE_INDUSTRIAL_CITY_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_STEAM_TRAIN_TRESTLE_CANYON_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MOUNTAIN_STONE_HOUSE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_UNDERGROUND_CRYSTAL_MINE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_ROBOT_RELIC_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SKY_PIRATE_FAMILY_TABLE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CHILDHOOD_MEMORY_HEARTH_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PROTECTIVE_PENDANT_AWAKENING_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_BURNING_FORTRESS_AIRSHIP_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PRINCESS_AND_PIRATE_GRANDMOTHER_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GRANDPARENTS_PLAYING_CHESS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_COMMAND_ROOM_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CASTLE_CLOSE_VIEW_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SACRED_GARDENS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_SANCTUARY_GATE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ANCIENT_FOREST_PATH_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_OVERGROWN_GREENHOUSE_DOME_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TREE_CROWN_CASTLE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_MEMORIAL_STONE_PLAQUE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GARDIAN_TREE_MEMORY_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_DOCKING_SKY_RUINS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_TREASURE_MECHANICAL_RELICS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_ROOTS_CRYSTAL_CORE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_AIRSHIP_FIRE_BLAST_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_HEIR_WATCHING_AIRSHIP_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CRYSTAL_SELF_DESTRUCTION_SPELL_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_CRUMBLING_ROOT_TOWER_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FLOATING_ISLAND_ROOTS_OVERVIEW_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_GLIDER_OVER_SACRED_GARDENS_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_PIRATES_TREASURE_JOY_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_SKY_PIRATES_ESCAPE_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FINAL_ASCENSION_NIGHT_1920x1080.png":"center center",
  "/erith-ia-memory/assets/images/ERITH_IA_BACKGROUND_CHATEAU_CIEL_FINAL_RETURN_SUNSET_1920x1080.png":"center center"
};
