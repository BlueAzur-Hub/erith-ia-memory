/* Agent-Crypto @erith.IA — Build 40.6.78
...
(() => {
  ...
  function captureIntent(event){if(!(event.target instanceof Element))return;if(!event.target.closest('#atlasAetherStatusToggle'))return;migrate('operator-pre-open');afterPaint('operator-open');}
  ...
  afterPaint('load');
  globalThis.ErithAetherV2Canonical=Object.freeze({build:BUILD,backplate,geometry_owner:'ErithAdministratorWindows',legacy_migration:true,atlas_explainability:false,weather_glyph:false,recurring_timer:false,observer:false,network_owner:false,market_core_changed:false,enhance,migrate});
})();
