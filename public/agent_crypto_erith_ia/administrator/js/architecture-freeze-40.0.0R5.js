(() => {
  ...
  /* ============================================================
     40.0.0R5 — VALIDATED METALLIC WINDOW MENUS / FULL FUNCTION RECOVERY PREFLIGHT
  ...
  function scriptOrder() {
    const expected = [
      ...
      "./js/architecture-freeze-40.0.0R5.js"
    ];
  ...
  function derive() {
    ...
    const checks = [
      ...
      check("Layout repair 40.0.0R5", !!globalThis.atlasAdministratorLayoutRepair3990R2 && hasScriptSuffix("/js/layout-repair-39.9.0R2.js"), "module DOM final + script unique"),
      ...
      check("Freeze singleton", hasScriptSuffix("/js/architecture-freeze-40.0.0R5.js"), "script 40.0.0R5 unique")
    ];
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">WINDOW MENUS RESTORE · 40.0.0R5 · READ ONLY</p>
  ...
  function render() {
    ...
    setText("architectureFreezeContract4000", data.pass
      ? "40.0.0R5 : Menus métalliques restaurés : Graphique, Target Top, Market Flow, Market Snapshot et Math Core gardent leurs commandes 5/5 ; ghost au repos, révélation au survol, aucune règle display:none destructive. Les limites de couverture restent visibles ; aucune n’est transformée en faux défaut structurel."
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Validated Metallic Window Menus Recovery 40.0.0R5", "",
  ...
  globalThis.atlasArchitectureFreeze4000R5 = Object.freeze({ derive, render, markdown });
