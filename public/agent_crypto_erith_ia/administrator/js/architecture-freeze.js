(() => {
  ...
  /* ============================================================
     40.1.8 — TECHNICAL READING CLASSIC GEOMETRY OWNER RESTORE LOCK
  ...
  function derive() {
    ...
    return {
      ...
      health,
      multi,
      contract: "ARCHITECTURE GELÉE · AUCUNE MUTATION AUTOMATIQUE · 40.1.8 CANDIDAT À VALIDER DANS FIREFOX"
    };
  }
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">ADMINISTRATOR CONSOLIDATION · 40.1.8 · READ ONLY</p>
          <h5 id="architectureFreezeTitle">Contrôle final 40.1.8</h5>
      ...
      <div class="atlas-memory-ledger-35">
        ...
        <article><span>Verdict</span><b id="architectureFreezeState">—</b><small>Préflight local 40.1.8 ; validation Firefox opérateur requise.</small></article>
      </div>
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Administrator Consolidation 40.1.8", "",
    ...
    lines.push(
      ...
      "- Le candidat 40.1.8 exige une validation réelle dans Firefox après publication opérateur.",
