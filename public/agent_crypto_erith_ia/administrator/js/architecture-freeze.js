(() => {
  ...
  /* ============================================================
     40.1.48 — PARKER LEWIS CAN'T LOSE · MATH CORE COMPLETE INLINE STRIP + MINIMIZED RESTORE RECOVERY LOCK
     ...
     CONTRACT
     - 40.1.48 keeps the Binance LIVE board outside historical datasets, illuminates the restored Metal bars without geometry changes, strengthens the whole positive 24h Technical Reading cell, and adds Oracle V1 on a separate canvas; no synthetic Chart.js endpoint or trading action.
     - NO automatic repair.
     - NO memory write.
  ...
  function derive() {
    ...
    const verticalBars = globalThis.__ATLAS_VERTICAL_BAR_RENDERER_40148__ || null;
    const oracleV1 = globalThis.__ATLAS_ORACLE_V1_40148__ || null;
    ...
    const checks = [
      ...
      check("Graphique · renderer vertical canonique + Metal illuminé",
        ...
        verticalBars ? `géométrie=${verticalBars.geometry_source} · base=${verticalBars.metal_paint_source} · illumination=${verticalBars.illumination?.composite}` : "contrat renderer vertical 40.1.48 absent"),
