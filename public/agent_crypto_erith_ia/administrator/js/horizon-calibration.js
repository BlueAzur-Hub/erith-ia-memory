...
(() => {
  ...
  function qApi(){return globalThis.AtlasRegimeQualifiedAnalogs||null;}
  ...
  function current(options={}){return analyze(globalThis.AtlasEventMemory?.current?.()||null,options);}
  globalThis.AtlasHorizonCalibration=Object.freeze({build:BUILD,schema:SCHEMA,analyze,current,horizon,wilson,read_only:true,new_storage_owner:false,storage_write:false,new_fetch:false,new_timer:false,new_observer:false,calibrated_probability:false,probability_claim:false,causal_claim:false,financial_signal:false,automatic_order:false});
})();
