(() => {
  ...
  /* ============================================================
     40.0.0R8 — UNIFIED METALLIC WINDOW MENUS / FULL FUNCTION RECOVERY PREFLIGHT
  ...
  function versionedAdminStyles() {
    const required = ["admin-windows.css", "admin-visual-assets.css", "admin-ribbons.css", "admin-window-menu-uniform-40.0.0R8.css"];
  ...
  function scriptOrder() {
    const expected = [
      ...
      "./js/architecture-freeze-40.0.0R8.js"
    ];
  ...
  function uniformMenuCssContract() {
    const sheet = [...document.styleSheets].find(item => pathOnly(item.href || "").endsWith("/admin-window-menu-uniform-40.0.0R8.css"));
  ...
  function derive() {
    ...
    const checks = [
      ...
      check("Menu métallique uniforme R8", uniformMenuCss.ok === true, uniformMenuCss.detail || "contrat uniforme absent"),
      ...
      check("Layout repair 40.0.0R8", !!globalThis.atlasAdministratorLayoutRepair3990R2 && hasScriptSuffix("/js/layout-repair-39.9.0R2.js"), "module DOM final + script unique"),
      ...
      check("Freeze singleton", hasScriptSuffix("/js/architecture-freeze-40.0.0R8.js"), "script 40.0.0R8 unique")
    ];
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">FAMILY WINDOW MENU RESTORE · 40.0.0R8 · READ ONLY</p>
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Unified Metallic Window Menus 40.0.0R8", "",
