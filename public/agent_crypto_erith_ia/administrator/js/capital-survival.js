...
(() => {
  ...
  function evaluate(input={}){
    const profile={...DEFAULT_PROFILE,...(input.profile||{})},calibration=input.calibration||globalThis.AtlasHorizonCalibration?.current?.({asset:input.asset})||null,cr=calibrationRisk(calibration);
