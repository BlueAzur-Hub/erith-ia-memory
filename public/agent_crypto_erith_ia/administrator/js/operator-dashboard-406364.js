/* Agent-Crypto Administrator — 40.6.364
   OPERATOR DASHBOARD · MATH CORE GLASS ALIGNMENT
   REDIVIDER confirmation is frozen from 40.6.363; Math Core NORMAL receives a lighter glass surface and fully centered visual hierarchy. */
(()=>{
  "use strict";
  if(globalThis.AgentCryptoOperatorDashboard406364)return;

  const BUILD="40.6.364";
  const ROOT_ID="agentCryptoOperatorDashboard406364";
  const STYLE_ID="agentCryptoOperatorDashboardStyle406364";
  ...
  function stopOwner(){
    if(typeof globalThis.strategyAAutoStop==="function"){
      return {kind:"function",run:()=>globalThis.strategyAAutoStop("KILL SWITCH · arrêt opérateur depuis le tableau de bord 40.6.364.")};
    }
  ...
  function openStopConfirm(trigger=null){
    ...
    const overlay=byId("acOperatorRedividerConfirm406364");
    ...
    requestAnimationFrame(()=>{
      const cancel=byId("acOperatorRedividerCancel406364");
  ...
  <div class="normal panel">
    ...
    <div class="body math-stage">
      <div class="math-hud">
        ...
        <div class="math-ring">
          <div class="ring-core">
            <span class="value" id="acOperatorMathScore406364">—</span>
            <small class="ring-label" id="acOperatorMathRingLabel406364">En attente</small>
          </div>
        </div>
        <span class="math-balance-rail right" aria-hidden="true"><i class="rail-mark"></i></span>
      </div>
      <div class="math-status" id="acOperatorMathContext406364">Contexte Market : en attente</div>
    </div>
  </div>
  <div class="mini">
    <button class="math-mini-ring" type="button" data-wing="math" data-mode="normal" aria-label="Ouvrir Math Core">
      <span class="mini-math-core">
        <span class="mini-score" id="acOperatorMathMiniScore406364">—</span>
        <span class="mini-math-label" id="acOperatorMathMiniLabel406364">En attente</span>
      </span>
    </button>
  </div>
</section>
...
<section class="wing kill-wing" aria-label="REDIVIDER · Kill Switch opérateur">
  <div class="normal panel">
    ...
    <div class="body redivider-stage">
      ...
      <div class="redivider-status" id="acOperatorRedividerStatus406364">PAPER ONLY · PRÊT</div>
      <span class="sr-only" id="acOperatorKillState406364" aria-live="polite">PRÊT</span>
      <span class="sr-only" id="acOperatorPaperOnly406364">PAPER ONLY</span>
      <span class="sr-only" id="acOperatorKillDetail406364">Auto A Paper · lecture et monitoring préservés.</span>
    </div>
  </div>
  <div class="mini">
...
<div class="redivider-confirm-overlay" id="acOperatorRedividerConfirm406364" data-confirm-overlay>
  <section class="redivider-confirm-modal" role="dialog" aria-modal="true" aria-labelledby="acOperatorRedividerConfirmTitle406364" aria-describedby="acOperatorRedividerConfirmDesc406364">
    <div class="confirm-eyebrow">KILL SWITCH OPÉRATEUR</div>
    <h2 class="confirm-title" id="acOperatorRedividerConfirmTitle406364">REDIVIDER</h2>
    ...
    <div class="confirm-safety" id="acOperatorRedividerConfirmDesc406364">
    ...
    <div class="confirm-state" id="acOperatorRedividerConfirmState406364">PAPER ONLY · PRÊT</div>
    <div class="confirm-actions">
      <button class="confirm-action cancel" id="acOperatorRedividerCancel406364" type="button" data-confirm-cancel>ANNULER</button>
      <button class="confirm-action confirm" id="acOperatorRedividerAccept406364" type="button" data-confirm-accept>CONFIRMER</button>
    </div>
  </section>
</div>
`;
    ...
    byId("acOperatorRedividerCancel406364")?.addEventListener("click",event=>{
      event.preventDefault();event.stopPropagation();closeStopConfirm("CANCEL");
    });
    byId("acOperatorRedividerAccept406364")?.addEventListener("click",event=>{
  ...
  function render(){
    ...
    const openScore=byId("acOperatorMathScore406364");
    if(openScore)openScore.textContent=scoreNumber;
    const miniScore=byId("acOperatorMathMiniScore406364");
    if(miniScore)miniScore.textContent=scoreNumber;
    const ringLabel=byId("acOperatorMathRingLabel406364");
    if(ringLabel)ringLabel.textContent=math.label;
    const miniLabel=byId("acOperatorMathMiniLabel406364");
    if(miniLabel)miniLabel.textContent=math.label;
    const context=byId("acOperatorMathContext406364");
  ...
  globalThis.AgentCryptoOperatorDashboard406364=Object.freeze({
    build:BUILD,
    mount,
    ...
    css_authority:"SINGLE_CLEAN_REWRITE_MATH_GLASS_REDIVIDER_CONFIRM_FROZEN"
  });
})();
