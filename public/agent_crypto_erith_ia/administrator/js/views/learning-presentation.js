/* Agent-Crypto @erith.IA — 40.4.47
   LEARNING JOURNEY SAFE POST-PARSE DOM DETACH / RUNTIME REBIND RECOVERY LOCK
   System presentation mounts structurally valid HTML first. The recovered Learning block
   is then removed as a validated DOM sibling range before app.js captures Learning refs.
   This deliberately retires the 40.4.44 string parser gate after operator regression.
