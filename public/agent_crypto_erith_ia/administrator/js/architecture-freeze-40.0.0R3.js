(() => {
  ...
  /* ============================================================
     40.0.0R3 — HOVER GHOST WINDOW CONTROLS CONTRACT / PREFLIGHT
  ...
  function scriptOrder() {
    const expected = [
      ...
      "./js/architecture-freeze-40.0.0R3.js"
    ];
  ...
  function derive() {
    ...
    const checks = [
      ...
      check("Layout repair 40.0.0R3", !!globalThis.atlasAdministratorLayoutRepair3990R2 && hasScriptSuffix("/js/layout-repair-39.9.0R2.js"), "module DOM final + script unique"),
      ...
      check("Freeze singleton", hasScriptSuffix("/js/architecture-freeze-40.0.0R3.js"), "script 40.0.0R3 unique")
    ];
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">HOVER GHOST CONTRACT · 40.0.0R3 · READ ONLY</p>
  ...
  function render() {
    ...
    setText("architectureFreezeContract4000", data.pass
      ? "40.0.0R3 : commandes fonctionnelles + chrome discret au repos + révélation au survol validés. Les limites de couverture restent visibles ; aucune n’est transformée en faux défaut structurel."
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Hover Ghost Window Controls Contract 40.0.0R3", "",
  ...
  globalThis.atlasArchitectureFreeze4000R3 = Object.freeze({ derive, render, markdown });
