(() => {
  ...
  /* ============================================================
     40.0.0 — STABLE CANDIDATE / FINAL PREFLIGHT
  ...
  function scriptOrder() {
    const expected = [
      ...
      "./js/architecture-freeze-40.0.0.js"
    ];
  ...
  function derive() {
    ...
    const checks = [
      ...
      check("Layout repair 40.0.0", !!globalThis.atlasAdministratorLayoutRepair3990R2 && hasScriptSuffix("/js/layout-repair-39.9.0R2.js"), "module DOM final + script unique"),
      ...
      check("Ancien Freeze non chargé", countScriptSuffix("/js/architecture-freeze-39.9.0.js") === 0 && countScriptSuffix("/js/architecture-freeze-39.9.0R1.js") === 0 && countScriptSuffix("/js/architecture-freeze-39.9.0R2.js") === 0, "anciens Freeze 39.9.0/R1/R2 non chargés"),
      check("Freeze singleton", hasScriptSuffix("/js/architecture-freeze-40.0.0.js"), "script 40.0.0 unique")
    ];
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">STABLE CANDIDATE · 40.0.0 · READ ONLY</p>
  ...
  function render() {
    ...
    setText("architectureFreezeContract4000", data.pass
      ? "40.0.0 : candidat stable cohérent. Les limites de couverture restent visibles ; aucune n’est transformée en faux défaut structurel."
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Stable Candidate 40.0.0", "",
  ...
  globalThis.atlasArchitectureFreeze4000 = Object.freeze({ derive, render, markdown });
