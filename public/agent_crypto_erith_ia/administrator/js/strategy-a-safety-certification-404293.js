...
(() => {
  ...
  function certificationMatrix(){
    const replay=moduleCheck("deterministic_replay",globalThis.AgentCryptoStrategyAReplay);
    const lifecycle=moduleCheck("paper_lifecycle",globalThis.AgentCryptoStrategyAPaperLifecycle);
    const metrics=moduleCheck("after_cost_metrics",globalThis.AgentCryptoStrategyAAfterCostMetrics);
    const m=globalThis.AgentCryptoStrategyAAfterCostMetrics?.summary?.()||{trades:0,sample_state:"INSUFFICIENT_SAMPLE",sample_min:30};
