/* Agent-Crypto Administrator — 40.6.357
   OPERATOR DASHBOARD · PREMIUM FINISH
   Single DOM/CSS authority. Premium finish over tempered crimson; geometry unchanged. */
(()=>{
  "use strict";
  if(globalThis.AgentCryptoOperatorDashboard406357)return;

  const BUILD="40.6.357";
  const ROOT_ID="agentCryptoOperatorDashboard406357";
  const STYLE_ID="agentCryptoOperatorDashboardStyle406357";
  ...
  function stopOwner(){
    if(typeof globalThis.strategyAAutoStop==="function"){
      return {kind:"function",run:()=>globalThis.strategyAAutoStop("KILL SWITCH · arrêt opérateur depuis le tableau de bord 40.6.357.")};
    }
...
<section class="wing math-wing" aria-label="Math Core synthétique">
  <div class="normal panel">
    ...
    <div class="body">
      <div class="math-row">
        <div class="math-ring"><div class="ring-core"><span class="value" id="acOperatorMathScore406357">—</span></div></div>
        <div class="math-copy">
          <b id="acOperatorMathLabel406357">En attente</b>
          <small id="acOperatorMathContext406357">Contexte Market : en attente</small>
        </div>
      </div>
    </div>
  </div>
  <div class="mini">
    <button class="math-mini-ring" type="button" data-wing="math" data-mode="normal" aria-label="Ouvrir Math Core">
      <span class="mini-math-core">
        ...
        <span class="mini-score" id="acOperatorMathMiniScore406357">—</span>
      </span>
    </button>
  </div>
</section>
      ...
      <div class="kill-layout">
        <div>
          <div class="kill-state">
            <strong id="acOperatorKillState406357">PRÊT</strong>
            <span class="paper" id="acOperatorPaperOnly406357">PAPER ONLY</span>
          </div>
          <div class="kill-detail" id="acOperatorKillDetail406357">Auto A Paper · lecture et monitoring préservés.</div>
        </div>
...
`;
  ...
  function render(){
    ...
    for(const id of ["acOperatorMathScore406357","acOperatorMathMiniScore406357"]){
      const node=byId(id);
      if(node)node.textContent=scoreText;
    }
    const label=byId("acOperatorMathLabel406357");
    if(label)label.textContent=math.label;
    const context=byId("acOperatorMathContext406357");
  ...
  globalThis.AgentCryptoOperatorDashboard406357=Object.freeze({
    build:BUILD,
    mount,
