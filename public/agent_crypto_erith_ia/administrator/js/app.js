(() => {
  ...
  const ADMIN_BUILD = "40.0.0R7";
  const ADMIN_RELEASE = "ADMINISTRATOR MIRROR · UNIFIED METALLIC WINDOW MENUS LOCK";
  ...
  function installGlobalVersionIdentity() {
    ...
    // 40.0.0R7 — COMPACT HOME LOCK · inherited from validated 39.9.0R2
