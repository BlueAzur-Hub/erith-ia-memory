(() => {
  ...
  const ADMIN_BUILD = "40.3.101";
  const ADMIN_RELEASE = "PARKER LEWIS CAN'T LOSE · AETHER CASCADE DEBT BATCH 2 · FIRST-PAINT NAV CANONICAL + ORACLE EVIDENCE WARM MIRROR + STORAGE BULK PRELOAD + ANALYTICAL MEMORY V2";
