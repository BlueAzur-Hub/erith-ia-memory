(() => {
  ...
  const ADMIN_BUILD = "40.0.0R6";
  const ADMIN_RELEASE = "ADMINISTRATOR MIRROR · GRAPH WINDOW MENU OPAQUE RESTORE LOCK";
  ...
  function installGlobalVersionIdentity() {
    ...
    // 40.0.0R6 — COMPACT HOME LOCK · inherited from validated 39.9.0R2
