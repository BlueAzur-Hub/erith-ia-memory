(() => {
  ...
  const ADMIN_BUILD = "40.3.100";
  const ADMIN_RELEASE = "PARKER LEWIS CAN'T LOSE · AETHER CASCADE DEBT BATCH 1 · MARKET EXTENDED LOOKUP + ATLAS ACTIVITY CHURN + ANALYTICAL MEMORY DELTA";
