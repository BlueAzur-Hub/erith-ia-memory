(() => {
  ...
  const ADMIN_BUILD = "40.0.0R3";
  const ADMIN_RELEASE = "ADMINISTRATOR MIRROR · STABLE CANDIDATE 40.0 · FROZEN 39.x ARCHITECTURE";
  ...
  function installGlobalVersionIdentity() {
    ...
    // 40.0.0R3 — COMPACT HOME LOCK · inherited from validated 39.9.0R2
