(() => {
  ...
  /* ============================================================
     39.9.0R2 — MEMORY ARCHITECTURE FREEZE / PREFLIGHT TRUTH REPAIR
  ...
  function scriptOrder() {
    const expected = [
      ...
      "./js/architecture-freeze-39.9.0R2.js"
    ];
  ...
  function derive() {
    ...
    const checks = [
      ...
      check("Layout repair 39.9.0R2", !!globalThis.atlasAdministratorLayoutRepair3990R2 && hasScriptSuffix("/js/layout-repair-39.9.0R2.js"), "module DOM final + script unique"),
      ...
      check("Ancien Freeze non chargé", countScriptSuffix("/js/architecture-freeze-39.9.0.js") === 0 && countScriptSuffix("/js/architecture-freeze-39.9.0R1.js") === 0, "anciens Freeze 39.9.0/R1 non chargés"),
      check("Freeze singleton", hasScriptSuffix("/js/architecture-freeze-39.9.0R2.js"), "script 39.9.0R2 unique")
    ];
  ...
  function ensureRoot() {
    ...
    root.innerHTML = `
      <div class="atlas-memory-intelligence-head">
        <div>
          <p class="eyebrow">ARCHITECTURE FREEZE · 39.9.0R2 · READ ONLY</p>
  ...
  function render() {
    ...
    setText("architectureFreezeContract3990R1", data.pass
      ? "39.9.0R2 : architecture consolidée. Les limites de couverture restent visibles ; aucune n’est transformée en faux défaut structurel."
  ...
  function markdown(data = derive()) {
    const lines = [
      "# Agent-Crypto — Architecture Freeze 39.9.0R2", "",
  ...
  function exportMarkdown() {
    ...
    const name = `agent_crypto_architecture_freeze_39_9_0R2_${stamp}.md`;
  ...
  const baseMemoryIntelligenceRender3990R2 = typeof globalThis.atlasMemoryIntelligenceRender === "function"
    ? globalThis.atlasMemoryIntelligenceRender
    : null;
  if (baseMemoryIntelligenceRender3990R2 && !baseMemoryIntelligenceRender3990R2.__freeze3990R2Wrapped) {
    const wrapped = function atlasMemoryIntelligenceRender3990R2(...args) {
      const result = baseMemoryIntelligenceRender3990R2.apply(this, args);
      queueMicrotask(() => { try { render(); } catch (_) {} });
      return result;
    };
    try { Object.defineProperty(wrapped, "__freeze3990R2Wrapped", { value: true }); } catch (_) {}
    globalThis.atlasMemoryIntelligenceRender = wrapped;
  }

  document.addEventListener("click", event => {
    const id = event?.target?.closest?.("button")?.id || "";
    if (id === "btnMemoryHealthRefresh3980R2" || id === "btnArchitectureFreezeRefresh3990R2") {
      queueMicrotask(() => { try { render(); } catch (_) {} });
    }
  });

  const freezeContract3990R2 = Object.freeze({
    build: BUILD_3990R2,
    role: "read-only architecture freeze preflight with final layout and truth synchronization",
    feature_delta: false,
  ...
  globalThis.__AGENT_CRYPTO_ARCHITECTURE_FREEZE_3990R2__ = freezeContract3990R2;
  globalThis.atlasArchitectureFreeze3990R2 = Object.freeze({ derive, render, markdown });
