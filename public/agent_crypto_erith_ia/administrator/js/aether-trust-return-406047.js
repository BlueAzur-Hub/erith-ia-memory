/* Agent-Crypto 40.6.47 — AETHER TRUST DIRECT-ADMIN RETURN LOCK
...
(() => {
  ...
  const bind = () => {
    ...
    if (!dialog || dialog.dataset.aetherTrustReturn406047 === "1") return;
    dialog.dataset.aetherTrustReturn406047 = "1";
  ...
  globalThis.ErithAetherTrustReturn406047 = Object.freeze({
    build:"40.6.47",
