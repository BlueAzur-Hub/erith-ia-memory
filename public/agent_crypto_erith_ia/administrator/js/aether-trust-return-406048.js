/* Agent-Crypto 40.6.48 — AETHER TRUST DIRECT-ADMIN RETURN LOCK
...
(() => {
  ...
  const bind = () => {
    ...
    if (!dialog || dialog.dataset.aetherTrustReturn406048 === "1") return;
    dialog.dataset.aetherTrustReturn406048 = "1";
  ...
  globalThis.ErithAetherTrustReturn406048 = Object.freeze({
    build:"40.6.48",
