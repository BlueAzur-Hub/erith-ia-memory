...
(()=>{
  ...
  const SECONDARY_MODULES=Object.freeze([
    ...
    "./js/market-reading-depth.js?v=40.6.413-probe",
    "./js/version-truth.js",
  ...
  const roundMs=value=>(value==null||value==="")?null:(Number.isFinite(Number(value))?Number(Number(value).toFixed(3)):null);
