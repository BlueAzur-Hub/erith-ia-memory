...
(() => {
  ...
  function renderAetherVeille4087(){
    ...
    const current=aetherVeilleCurrent4087(),copies=host.querySelectorAll("[data-aether-veille-copy-4087]"),brand=host.querySelector(".atlas-aether-veille-brand-4087");
