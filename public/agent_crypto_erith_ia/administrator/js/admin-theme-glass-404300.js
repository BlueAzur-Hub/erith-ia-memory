...
(() => {
  ...
  function install(){const b=document.getElementById("atlasThemeGlassToggle404300");if(b&&!b.dataset.bound404300){b.dataset.bound404300="1";b.addEventListener("click",toggle);}apply(read(),{persist:false});}
