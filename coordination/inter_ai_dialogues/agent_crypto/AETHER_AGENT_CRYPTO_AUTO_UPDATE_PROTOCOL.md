...
- Private Backend executable or local Ryzen installation;
...
Published authority when this protocol was installed: `40.4.58`.

Next planned research boundary: stronger DEX token/address identity proof. Because address-level canonical identity may require a verified token registry and/or a local backend contract change, this work is classified as a human-review boundary before automatic deployment.
