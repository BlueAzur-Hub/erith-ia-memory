/* Agent-Crypto 40.6.49 — AETHER TRUST DIRECT-ADMIN RETURN LOCK
...
(() => {
  ...
  const bind = () => {
    ...
    if (!dialog || dialog.dataset.aetherTrustReturn406049 === "1") return;
    dialog.dataset.aetherTrustReturn406049 = "1";
  ...
  globalThis.ErithAetherTrustReturn406049 = Object.freeze({
    build:"40.6.49",
